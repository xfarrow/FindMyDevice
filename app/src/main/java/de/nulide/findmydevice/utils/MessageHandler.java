...
public class MessageHandler {
    ...
    public static void handle(String sender, String msg, Context context) {
        ...
        } else if (msg.startsWith(settings.get(Settings.SET_FMD_COMMAND) + " ring")) {
        ...
        } else if (msg.startsWith(settings.get(Settings.SET_FMD_COMMAND) + " lock") && Permission.DEVICE_ADMIN) {
        ...
        } else if (msg.startsWith(settings.get(Settings.SET_FMD_COMMAND) + " stats")) {
        ...
        } else if (msg.startsWith(settings.get(Settings.SET_FMD_COMMAND) + " delete") && Permission.DEVICE_ADMIN) {
