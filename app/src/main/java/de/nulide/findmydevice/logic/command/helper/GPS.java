...
public class GPS implements LocationListener {
    ...
    public GsmCellLocation sendGSMCellLocation(Settings Settings) {
        ...
        if (location != null) {
            ...
            if (!TextUtils.isEmpty(operator)) {
                ...
                if (!((String) Settings.get(Settings.SET_OPENCELLID_API_KEY)).isEmpty()) {
                    StringBuilder urlBuilder = new StringBuilder("https://opencellid.org/cell/get?key=")
                            .append((String) Settings.get(Settings.SET_OPENCELLID_API_KEY)).append("&mcc=").append(mcc).append("&mnc=").append(mnc)
